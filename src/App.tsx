...
import { AdminPage, LoginPage, ManageEventPage, ManageUserPage, UpcaommingEventPage, UserPage } from "./pages/pages";
// import {
//   AdminProfilePage,
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/upcommingEvents" element={<UpcaommingEventPage />} />
